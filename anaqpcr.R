anaqpcr<-function(primer=c(...),repli=2,rq="TBP",Standard="n",cond=c(...),dna1=c(-1.806179974,-1.505149978,-1.204119983,-0.602059991),dna2=c(-1.505149978,-1.204119983,-0.602059991,0),dna=c(...),rev="n",Robustness="n",timepoint="n",de="n",save="n",w=9.5,h=7,
			     ...
			     title="",labelX="",labelY="mRNA level relative to TBP",col=c(1:100),colbar=c("black"),
			     size_lab=3,size_main=5,size_axis=2,cex.names=2,
			     legend_size=2,pos.legend="topright",xleg=max(nb)+0.15,yleg=yleg,data=data,nb=c(0:5)) {
if (data=="choose"){
